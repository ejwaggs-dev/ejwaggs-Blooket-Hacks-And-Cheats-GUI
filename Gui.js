(async () => {
    ...
    if (console.log("%c Ejwaggs´s Blooket Hacks / Cheats %c\n	Modified by Ejwagg's on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/ejwaggs-dev/ejwaggs-Blooket-Hacks-And-Cheats-GUI", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let c = {
        ...
        setItem(e, t) {
            return e.split(".").reduce((e, a, o, r) => (e[a] = (e[a] ? e[a] : {}), ++o == r.length && (e[a] = t), e[a]), this.data),
                localStorage.setItem("EJWAGGSGUISettings", JSON.stringify(this.data)),
                this.data
        },
        deleteItem(e) {
            return e.split(".").reduce((e, t, a, o) => (++a == o.length && delete e[t], e[t]), this.data),
                localStorage.setItem("EJAGGSGUISettings", JSON.stringify(this.data)),
                this.data
        },
        setData(e) {
            this.data = e,
    ...
    try {
        for (let d of (c.data = JSON.parse(localStorage.getItem("EJWAGGSGUISettings") || "{}"), ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Ejwaggs´s Cheats<sup>v1.0</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
